export const formControlClasses = 'mt-2 w-full rounded-xl border border-slate-300 bg-white px-4 py-3 text-navy shadow-sm transition placeholder:text-slate-400 focus:border-primary focus:outline-none focus:ring-4 focus:ring-primary/10'
